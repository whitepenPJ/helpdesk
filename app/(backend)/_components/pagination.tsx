...
export function Pagination({
  ...
  // Up to 10 numbered links plus First/Prev/Next/Last can be wider than a
  // narrow viewport — this strip scrolls on its own rather than forcing the
  // whole page to scroll sideways (the page body must never do that).
  return (
