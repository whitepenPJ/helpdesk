...
export default async function ViewUserPage({ params }: PageProps<"/master/user/[id]/view">) {
  ...
  return (
    <>
      <PageHeader title="View User" role={session.user.role} breadcrumbs={[{ label: "Users", href: "/master/user" }, { label: "View" }]} />
