...
export default async function TicketsPage({ searchParams }: PageProps<"/tickets">) {
  ...
  return (
    <>
      <PageHeader title="Tickets" role={session.user.role} />
                ...
                <div className="card-header">
                  <div className="row g-2 align-items-center">
                    <div className="col-12 col-md-12">
                      <form method="get" className="d-flex gap-2 align-items-stretch align-items-md-center flex-column flex-md-row flex-wrap">
                        <TicketSearchInput defaultValue={query} />
                        <div style={{ minWidth: "16rem", maxWidth: "100%" }}>
                          <Select2Select
                            name="status"
                            multiple
                            small
